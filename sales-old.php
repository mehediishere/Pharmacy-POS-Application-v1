                  ...
                  <div class="card-body">
                    <table id="example1" class="table table-bordered table-hover">
                      ...
                      <tbody>
                        <?php
                          $n = 0;
                          $sql = $conn->query("SELECT * FROM `invoice_summary` WHERE `store` = '$_SESSION[store_id]' ORDER BY `id` DESC");
                        ...
                        <tr>
                          ...
                          <td>
                            <ul>
                              <?php
                                $purchaseCost = 0;
                                $medicine = $conn->query("SELECT * FROM `invoice` WHERE `invoice` = $row[invoice]");
                          ...
                          <td><?php echo $row['discount']." ".$row['discount_type']; ?></td>
                          <td>
                            <?php 
                              if($row['discount_type'] == "flat"){
                                $receivableAmount = $row['total_price'] - $row['discount'];
                              }else{
                                  $receivableAmount = $row['total_price'] - ($row['total_price']*($row['discount']/100));
                              }
                              echo $receivableAmount; 
                            ?>
                          </td>
                          <td><?php echo $row['paid']; ?></td>
                          <td><?php echo $row['due']; ?></td>
                          <td><?php echo $purchaseCost; ?></td>
                          <td><?php echo $receivableAmount - $purchaseCost; ?></td>
                          ...
                          <td class="text-center">
                            <div class="btn-group">
                              ...
                              <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; top: 30px; left: 0px; will-change: top, left;">
                                <a class="dropdown-item" href=""> <i class="fa fa-history text-cyan"></i> Sell History </a> 
                                ...
                                <a class="dropdown-item" href=""> <i class="fa fa-edit text-warning"></i> Edit </a> 
